...
# width = 64 is the standard ResNet18
def resnet18k(width=64, num_classes=10) -> PreActResNet:
    return PreActResNet(PreActBlock, [2, 2, 2, 2], num_classes=num_classes, init_channels=width)

# width = 64 is the standard ResNet
def resnet50k(width=64, num_classes=10) -> PreActResNet:
    return PreActResNet(PreActBottleneck, [3,4,6,3], num_classes=num_classes, init_channels=width)
